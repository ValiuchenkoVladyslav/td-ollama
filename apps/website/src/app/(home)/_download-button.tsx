...
const downloadMenuItem =
  "text-lg sm:text-xl flex gap-3 font-semibold items-center";
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          size="lg"
          className="text-lg font-bold mt-2 gap-2 w-full sm:w-[320px]"
        >
      ...
      <DropdownMenuContent className="!border-white/40 max-w-[240px] sm:max-w-none sm:w-[320px]">
        ...
        <DropdownMenuSub>
          <DropdownMenuSubTrigger className={downloadMenuItem}>
            <svg
              stroke="currentColor"
              fill="currentColor"
              viewBox="0 0 448 512"
